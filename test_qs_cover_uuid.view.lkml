view: test_qs_cover_uuid {
  sql_table_name: actian.test_qs_cover_uuid ;;
  ...
  measure: count {
    type: count
    drill_fields: [originator_name, most_recent_insurer_name, contact_house_name, consumer_name, risk_house_name]
  }
}
