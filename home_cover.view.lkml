view: home_cover {
  sql_table_name: actian.home_cover ;;
  ...
  dimension: risk_address_rating_factor {
    type: string
    sql: ${TABLE}.risk_address_rating_factor ;;
  }

  dimension: risk_address_uprn {
    type: number
    sql: ${TABLE}.risk_address_uprn ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [joint_forename, surname, forename, joint_surname]
  }
}
